...
### Note: this script should be run with "CLASS2020/" as the working directory
...
>>>>>>> 0d28a6e3914a243b7a10e607c91484090ab05953
...
Figure B: Scatter plot of expression vs. number of DNA-binding factors bound for lncRNA and protein-coding promoters
=======
...
Figure E: Histogram of promoters by gene expression for different DNA-binding factor densities
=======
...
g + geom_point() +
    geom_text_repel(
    data = subset(chisq_res, padj < 10^-38),
    aes(label = tf),
    size = 3,
