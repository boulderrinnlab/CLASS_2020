...
peaksa <- rtracklayer::import("/Shares/rinn_class/data/CLASS_2020/analysis/01_consensus_peaks/results/POLR2A_consensus_peaks.bed")
peaksb <- rtracklayer::import("/Shares/rinn_class/data/CLASS_2020/analysis/01_consensus_peaks/results/POLR2B_consensus_peaks.bed")
polii_peak_list <- c(peaksa, peaksb)

pol_ghost_overlaps <- findOverlaps(polii_peak_list,ghost_promoters)
