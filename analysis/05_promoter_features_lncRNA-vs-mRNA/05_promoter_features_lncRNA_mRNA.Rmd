...
```{r}
# Import peaks
peak_list <- import_peaks("/Shares/rinn_class/data/CLASS_2020/analysis/01_consensus_peaks/results/consensus_peaks/filtered_by_peaks/")
# Import gencode
...
ggsave("figures/dbps_depleted_on_promoters.pdf")
```
