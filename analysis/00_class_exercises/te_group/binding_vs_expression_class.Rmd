...
counts <- featureCounts(c("/scratch/Users/deta9300/Rinn_class_repository/class_2020/CLASS_2020/analysis/00_class_exercises/te_group/rna_seq_bam/ENCFF625ZBS.bam", "/scratch/Users/deta9300/Rinn_class_repository/class_2020/CLASS_2020/analysis/00_class_exercises/te_group/rna_seq_bam/ENCFF630HEX.bam"),
...
peaks_and_expression <- merge(peak_occurence_df, gene_type_df)
peaks_and_expression <- merge(peaks_and_expression, tpm)
```


```{r}
# Use what you just made to plot the results.
g <- ggplot(peaks_and_expression, aes(y = log10(tpm), x = number_of_tfs, color = transcript_type))
