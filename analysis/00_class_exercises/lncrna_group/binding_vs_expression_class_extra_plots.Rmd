...
```{r plotting_expression_vs_binding_events_but_now_there_are_ghosts_that_have_no_binding_and_the_messy_dot_situation_is_gone}
...
```{r plotting_frequency_of_promoters_with_each_peak_density_and_histograms_for_peaks_of_diffeent_biotypes}
