...
### Goals of this code:
1) Make a density plot of number of transcription factors bound at a given promoter.
2) What promoters are never bound by TFs?
3) Are there any DNA binding proteins that did not overlap at any promoter?
 

Question #1: Density plot of TFs bound at promoters
```{r}
...
```
Figure 1. Density plot of number of binding events at a given promoter.
...
Question #2: Which promoters are never bound?
...
#see not_bound_proms for list of promoters
```

Questions #3: Which DNA binding proteins did not overlap at any promoter?
```{r}
