...
largest_rfx1_peak <- filtered_consensus_peaks[["RFX1"]][which.max(width(filtered_consensus_peaks[["RFX1"]]))]
...
# Just as an example of plotting multiple dbps, let's add in another here
# in this same region
# TODO: clean this up later. 
plot_replicate_peaks(c("RFX1", "AFF1"), 
                     region, 
                     bw_axis_limits = list(c(0,0.6), c(0,1)),
                     plot_title = "RFX1 AFF1 peaks",
                     height_per_dbp = 4,
                     fixed_height = 3,
                     save_pdf = T,
                     pdf_path = "figures/RFX1_AFF1_peak_track.pdf",
                     display_plot = F)
```
