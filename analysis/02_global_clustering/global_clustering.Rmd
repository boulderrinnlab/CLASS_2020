...
```{r hclust-all, fig.height=12, fig.width=5}
...
```{r hclust-lnrna, fig.height=12, fig.width=5}
...
```{r hclust-mrna, fig.height=12, fig.width=5}
...
```{r umap-all, fig.height=10, fig.width=10.5}
